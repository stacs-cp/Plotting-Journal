(define (problem plt2_7_7_6_24)
    ...
    (:init
        ...
        (coloured loc_2_2 violet)
        (coloured loc_3_2 red)
        (coloured loc_4_2 blue)
        (coloured loc_5_2 violet)
        ...
        (coloured loc_5_7 blue)
        (coloured loc_6_7 yellow)
        (coloured loc_7_7 red)
