   ...
   ; is there something that needs to fall?
    ...
    (:action vertical_bullet_advancing_non_absorbing
     ...
     (:action shooting_row_7
       ...
       :effect
         (and
             (coloured loc_1_7 bullet)
             (shooting_horizontal_flag)
             (increase (total-cost) 1)
         )
     )

     (:action shooting_row_8
       :precondition
       (and
         (not (shooting_horizontal_flag))
         (not (shooting_vertical_flag))
       ...
       :effect
         (and
             (coloured loc_1_8 bullet)
             (shooting_horizontal_flag)
             (increase (total-cost) 1)
         )
     )

     (:action shooting_row_9
       :precondition
       (and
         (not (shooting_horizontal_flag))
         (not (shooting_vertical_flag))
     ...
     (:action shooting_column_6
       ...
       :effect
         (and
             (coloured loc_6_9 bullet)
             (shooting_vertical_flag)
             (increase (total-cost) 1)
         )
     )

     (:action shooting_column_7
       :precondition
       (and
         (not (shooting_horizontal_flag))
         (not (shooting_vertical_flag))
       ...
       :effect
         (and
             (coloured loc_7_9 bullet)
             (shooting_vertical_flag)
             (increase (total-cost) 1)
         )
     )

     (:action shooting_column_8
       :precondition
       (and
         (not (shooting_horizontal_flag))
         (not (shooting_vertical_flag))
